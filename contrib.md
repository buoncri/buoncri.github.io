...
> **Nota:** elenco raggruppato per repository, generato il **2026-09-08** via GitHub Search API (`search/issues?q=author:buoncri is:public`, 66 risultati totali — solo repository pubblici). I conteggi includono PR e issue. Sotto trovi dettaglio per i repo con più attività; i singoli contributi minori sono in coda in "Altri".
