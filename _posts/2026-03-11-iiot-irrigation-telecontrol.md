...
In fase di preparazione al rilascio pubblico ho fatto una bella analisi del codice e... mi sono accorto che, per sbaglio, avevo lasciato allâ€™interno del repository alcune informazioni sensibili! (era rimasta la chiave api di portainer :-D, niente di grave, ora l'ho tolta e non viene piÃ¹ salvata :-D)
